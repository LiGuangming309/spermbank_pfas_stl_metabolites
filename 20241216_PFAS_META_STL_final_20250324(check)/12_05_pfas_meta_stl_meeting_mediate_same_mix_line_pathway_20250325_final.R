...
df_rawdata_q %>% 
  select(1,M397:M428) -> df_meta_final
...
cairo_pdf("result/20240407_PFOA_sperm/Multi_linear_regression_20240407/metabolomics/pfas_meta_stl_20241216/pathway/pfas_meta_STL_20241218_fdr_network_liner.pdf",width = 8, height = 9,family = "Arial")
opar <- par(no.readonly = TRUE)
par(pin = c(9,16), mar = c(7,7.5,1,1.5))  ##,mgp=c(3,2,0)
...
meta_STL_mix_kegg_meta_final_4_pfas %>% 
  ...
  mutate(group=rep("STL",9))-> meta_STL_mix_kegg_meta_final_4_pfas_1
...
meta_STL_mix_kegg_meta_final_4_pfas %>% 
  ...
  mutate(group=rep("PFAS",9))-> meta_STL_mix_kegg_meta_final_4_pfas_2
