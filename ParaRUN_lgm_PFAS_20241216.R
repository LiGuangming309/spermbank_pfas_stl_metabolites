...
############################读入数据#################################
df_background_DNA_LT_sperm_PFOA_meta_tidy_noNA <- read_excel("/dssg/home/acct-yxwang0203/yxwang0203/work_data/pfas_STL_meta/result_pfas_rawdata_623.xlsx")
...
g_coefs_PFAS_meta <- allgather(coefs)

if(comm.rank() == 0){
  save(g_coefs_PFAS_meta, file = 'coefs_PFAS_meta.Rdata')
}
